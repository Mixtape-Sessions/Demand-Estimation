...
\begin{frame}{Limited Cross-Market Variation}
    \begin{wideitemize}
        ...
        \end{itemize}
        \pause
        \item Also can't estimate a parameter in $\Pi$ on income alone.
        \begin{itemize}
...
\begin{frame}{Within-Market Variation}
    \begin{wideitemize}
        ...
        \begin{itemize}
            \item ``What was your annual income last year?''
            \item ``What would you have purchased if your mushy cereal wasn't available?''
        \end{itemize}
    \end{wideitemize}
\end{frame}
...
\begin{frame}{Micro BLP Estimator}
    ...
    \begin{wideitemize}
        ...
        \pause
        \begin{enumerate}
            \item \alert<2>{$\overline{v}_1$}: Mean income of cereal purchasers.
            \pause
            \item \alert<3>{$\overline{v}_2$}: Share of cereal purchasers who chose a mushy cereal and would choose another mushy cereal if their first choice wasn't available.
        \end{enumerate}
        \pause
...
\begin{frame}{Micro Statistics}
    \begin{wideitemize}
        ...
        \begin{enumerate}
            ...
            \pause
            \item Selected to be in the survey with known probability $w_{di_nj_nt_n}$. This is new.
        \end{enumerate}
        \pause
...
\begin{frame}{Coding Exercise 3}
    \begin{wideitemize}
        ...
        \end{itemize}
        \pause
        \item We'll post solutions to all the exercises.
    \end{wideitemize}
\end{frame}
