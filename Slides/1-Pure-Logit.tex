...
\begin{frame}{Typical Instruments for Price}
    ...
    \begin{wideitemize}
        ...
        \only<3->{\vspace{-0.02\baselineskip}}
        \only<4->{\vspace{0.09\baselineskip}}
        \only<6->{\vspace{-0.15\baselineskip}}
        ...
        \pause
        \only<3->{\vspace{-0.13\baselineskip}}
        \only<4->{\vspace{0.09\baselineskip}}
        \only<6->{\vspace{-0.19\baselineskip}}
        ...
        \pause
        \only<5->{\vspace{-0.12\baselineskip}}
        \only<6->{\vspace{-0.19\baselineskip}}
        ...
        \pause
        \only<6->{\vspace{-0.29\baselineskip}}
