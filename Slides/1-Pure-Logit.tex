...
\begin{frame}{Typical Instruments for Price}
    ...
    \begin{wideitemize}
        ...
        \pause
        \item \defcitealias{hausman1996valuation}{Hausman}\citetalias{hausman1996valuation}: Price of the same product averaged across \textit{other} locations.
        \only<2>{
            \begin{itemize}
        ...
        \only<4>{
            \begin{itemize}
                \item Price is marginal cost plus a markup. Substitutes affect markups.
